...
//Use the standard namespace because I don't wannt type "std::" over and over again
using namespace std;
...
public:
     ...
     * O(n)
     *
     * returns true this list contains data
     *
     * @param data to check for in this list
     * @return true this list contains data
     */
    bool contains(T data) {
        //if the list is empty, we dont' contain whatever data is
        if (this->head == nullptr) {
            return false;
        }
        ...
        //we made it through every node without finding it,
        // so it's not there
        return false;
    }
